...
-- ДОБАВЛЕНО: информация при запуске
print("========================================")
print("      MOBILE CONTROLS WITH SPEED       ")
print("========================================")
print("Управление:")
print("Кнопка + (зеленая) - увеличить скорость")
print("Кнопка - (оранжевая) - уменьшить скорость")
print("Стрелка вверх - подъем")
print("Стрелка вниз - спуск")
print("Текущая скорость: " .. currentSpeed)
print("========================================")
